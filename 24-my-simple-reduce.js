...
*******************************************************************************/
/*to refactor this problem to take in
an optional initial accumulator
I would add it to the function arguments
(so it would be the tirhd argument)
and then set a conditional so
if the third argument is undefined
the function would run as it is
and if the third argument is incoming
it would be the accumulator in the callback function
*/
